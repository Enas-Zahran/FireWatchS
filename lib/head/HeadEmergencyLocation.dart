...
class HeadEmergencyLocationsPage extends StatefulWidget {
  const HeadEmergencyLocationsPage({super.key});

  @override
  State<HeadEmergencyLocationsPage> createState() =>
      _HeadEmergencyLocationsPageState();
}

class _HeadEmergencyLocationsPageState
    extends State<HeadEmergencyLocationsPage> {
...
Future<void> _loadData() async {
  ...
  List<Map<String, dynamic>> _tasksForLocation(String code) {
    return emergencyTasks.where((task) {
      final match =
            ...
            loading
                ...
                : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final remaining = tasksInLocation.length;
