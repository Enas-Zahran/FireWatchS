...
class ManagerEmergencyReports extends StatefulWidget {
  ...
  @override
  State<ManagerEmergencyReports> createState() =>
      _ManagerEmergencyReportsState();
}

class _ManagerEmergencyReportsState extends State<ManagerEmergencyReports> {
  ...
  Map<String, String> toolTypesMap = {};
    ...
    setState(() {
      filteredReports =
          allReports.where((report) {
            ...
            final toolType = toolTypesMap[toolName] ?? '';
