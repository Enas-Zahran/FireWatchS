...
class PendingEmergencyRequestsPage extends StatefulWidget {
  ...
  @override
  State<PendingEmergencyRequestsPage> createState() =>
      _PendingEmergencyRequestsPageState();
}

class _PendingEmergencyRequestsPageState
    extends State<PendingEmergencyRequestsPage> {
      ...
      builder: (context) {
        return Directionality(
          ...
          child: AlertDialog(
            ...
            content: const Text(
              'هل أنت متأكد أنك تريد رفض هذا الطلب؟ سيتم حذفه نهائياً.',
            ),
            actions: [
              TextButton(
