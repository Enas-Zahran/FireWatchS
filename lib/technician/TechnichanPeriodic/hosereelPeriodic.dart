...
class _HoseReelReportPageState extends State<HoseReelReportPage> {
  ...
  final List<String> steps = [
    'تفقد البكرة (الرول) وعدم وجود تشققات أو تلف.',
    'تفقد الخرطوم والتأكد من عدم وجود تلف أو ثقوب.',
    'تفقد ضغط الماء داخل الخرطوم.',
    'تفقد فوهة الخرطوم وعملها بشكل صحيح.',
    'التحقق من عدم وجود تسريبات في النظام.',
    'تفقد آلية الفك والتركيب للبكرة.',
    'التأكد من وضوح العلامات والإشارات.',
    'تفقد تزييت الأجزاء المتحركة إذا لزم.'
  ];
